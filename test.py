...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='/home/Workspace/my1997/Reconstruction-by-inpainting-for-visual-anomaly-detection-main/data/mvtec_anomaly_detection')
